...
The Borr Project curriculum is a **complete education in mathematics** using online materials.
...
**Cost**. The Borr Project strives to identify free resources to reach your learning goal. However, some courses may charge money for assignments/tests/projects to be graded.
...
- Courses in Core Mathematics are the basic requirements for all Borr Project Math students and provide a foundation for deeper study. Take all of these courses.
...
Courses | Duration | Effort | Prerequisites
:-- | :--: | :--: | :--:
[Calculus 1A: Differentiation](https://openlearninglibrary.mit.edu/courses/course-v1:MITx+18.01.1x+2T2019/about) | 13 weeks | 6-10 hours/week | [high school math](../../precollege-math)
...
Courses | Duration | Effort | Prerequisites
:-- | :--: | :--: | :--:
[Introduction to Abstract Group theory](https://nptel.ac.in/courses/111106113) | 8 weeks | 8-10 hours/week | [high school math](../../precollege-math) 
...
Courses | Duration | Effort | Prerequisites
:-- | :--: | :--: | :--:
[Topology Without Tears](https://www.topologywithouttears.net) | 15 weeks | 14 hours/week | [high school math](../../precollege-math), Set Theory, Knowledge of axiomatic branch of mathematics such as [Introduction to Abstract Algebra](#introduction-to-abstract-algebra) 
