...
No. The Borr Project creates guides to resources that will empower you to learn the curriculum of an undergraduate degree. Individuals who used to be involved in OSSU or the Borr Project may be working with other organizations to offer degrees, but the Borr Project is not involved in those efforts.
